...
public class OpeningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button_signIn_register).setOnTouchListener(mDelayHideTouchListener);

        Button SignInOrRegister = (Button) findViewById(R.id.button_signIn_register);
